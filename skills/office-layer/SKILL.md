...
> 详见 `../../THIRD_PARTY_NOTICES.md` 的「许可证合规」一节。
...
```bash
bash skills/office-layer/bootstrap.sh          # 创建 .venv 并装依赖
...
| 现象 | 处理 |
|---|---|
| `ModuleNotFoundError: docx/pptx/openpyxl` | 没走 venv。用 `skills/office-layer/.venv/bin/python` |
